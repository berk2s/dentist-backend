...
public final class SwaggerExample {
    ...
    public static final String INVALID_REQUEST = "{\"error\":\"invalid_request\",\"error_description\":\"Invalid request\",\"code\":\"request.invalid\",\"details\":[\"Username must not be empty\",\"Scopes must not be empty\",\"Password must not be empty\"]}";
